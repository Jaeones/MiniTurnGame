...
public class GameManager : MonoBehaviour
{
    ...
    public GameObject player1; // 검사 오브젝트 연결
    public GameObject player2; // 사제 오브젝트 연결
    public GameObject player3; // 마법사 오브젝트 연결
    ...
    private void StatusShow()
    {
        ...
        {
            priestText[0].text = p2Script.pdata.job;     // swordmanText -> priestText로 수정
        ...
        {
            witchText[0].text = p3Script.pdata.job;      // swordmanText -> witchText로 수정
